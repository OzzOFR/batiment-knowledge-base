...
def clean_ocr(text: str) -> str:
    ...
    for line in lines:
        ...
        if not line:
            continue
        # Ignorer les lignes trop courtes (souvent des numéros de page ou du bruit)
...
def chunk_text(text: str, max_chars: int = 1500) -> list[str]:
    ...
    # Séparer grossièrement par blocs de lignes vides ou sauts de ligne
    paragraphs = text.split('\n\n')
    if len(paragraphs) < 10:
        # Si pas assez de paragraphes (OCR compact), forcer la séparation sur les points
...
if __name__ == "__main__":
    print("=== Indexation des ouvrages de Barberot dans Supabase ===")
    
    base_dir = "/home/ubuntu/batiment-knowledge-base/corpus/barberot"
    
    files_to_index = [
        ("barberot_menuiserie_1911.txt", "menuiserie", "Traité pratique de menuiserie (Barberot, 1911)"),
        ("barberot_constructions_civiles_1900.txt", "encyclopedie-generale", "Traité de constructions civiles (Barberot, 1900)")
    ]
